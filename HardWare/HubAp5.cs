...
namespace HardWare
{
    ...
    public class HubAP5 
    {
        ...
        /// </summary>
        public Socket HubSocket1 { get { return this.sockets[0]; } }

        /// <summary>
        /// Returns the socket number for socket 2 on the hub.
        /// </summary>
        public Socket HubSocket2 { get { return this.sockets[1]; } }

        /// <summary>
        /// Returns the socket number for socket 3 on the hub.
        /// </summary>
        public Socket HubSocket3 { get { return this.sockets[2]; } }

        /// <summary>
        /// Returns the socket number for socket 4 on the hub.
        /// </summary>
        public Socket HubSocket4 { get { return this.sockets[3]; } }

        /// <summary>
        /// Returns the socket number for socket 5 on the hub.
        /// </summary>
        public Socket HubSocket5 { get { return this.sockets[4]; } }

        /// <summary>
        /// Returns the socket number for socket 6 on the hub.
        /// </summary>
        public Socket HubSocket6 { get { return this.sockets[5]; } }

        /// <summary>
        /// Returns the socket number for socket 7 on the hub.
        /// </summary>
        public Socket HubSocket7 { get { return this.sockets[6]; } }

        /// <summary>
        /// Returns the socket number for socket 8 on the hub.
        /// </summary>
        public Socket HubSocket8 { get { return this.sockets[7]; } }

        /// <summary>Constructs a new HubAP5 module.</summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        public HubAP5(Cpu.Pin interruptPin)
        {

            this.io60 = new IO60P16(interruptPin);
            ...
            for (int i = 0; i < 8; i++)
            {
                ...
                this.sockets[i].DigitalInputIndirector = (indirectedSocket, indirectedPin, glitchFilterMode, resistorMode) => new DigitalInputImplementation(this.GetPin(indirectedSocket, indirectedPin), glitchFilterMode, resistorMode, this.io60);
                this.sockets[i].DigitalOutputIndirector = (indirectedSocket, indirectedPin, initialState) => new DigitalOutputImplementation(this.GetPin(indirectedSocket, indirectedPin), initialState, this.io60);
                this.sockets[i].DigitalIOIndirector = (indirectedSocket, indirectedPin, initialState, glitchFilterMode, resistorMode) => new DigitalIOImplementation(this.GetPin(indirectedSocket, indirectedPin), initialState, glitchFilterMode, resistorMode, this.io60);
                this.sockets[i].AnalogInputIndirector = (indirectedSocket, indirectedPin) => new AnalogInputImplementation(this.GetPin(indirectedSocket, indirectedPin), this.ads, this.io60);
                this.sockets[i].PwmOutputIndirector = (indirectedSocket, indirectedPin, invert) => new PwmOutputImplementation(this.GetPin(indirectedSocket, indirectedPin), invert, this.io60);
                this.sockets[i].InterruptIndirector = (indirectedSocket, indirectedPin, glitchFilterMode, resistorMode, interruptMode) => new InterruptInputImplementation(this.GetPin(indirectedSocket, indirectedPin), glitchFilterMode, resistorMode, interruptMode, this.io60);
            }
        }
        ...
        private class DigitalInputImplementation : DigitalInput
        {
            private IO60P16 io60;
            private byte pin;

            public DigitalInputImplementation(byte pin, GlitchFilterMode glitchFilter, Port.ResistorMode resistorMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
        ...
        private class DigitalOutputImplementation : DigitalOutput
        {
            private IO60P16 io60;
            private byte pin;
            ...
            public DigitalOutputImplementation(byte pin, bool initialState, IO60P16 io60)
            {
                ...
                this.io60.setIOMode(this.pin, IO60P16.IOState.Output, Port.ResistorMode.Disabled);
        ...
        private class DigitalIOImplementation : DigitalIO
        {
            private IO60P16 io60;
            private byte pin;
            private IOMode mode;
            private Port.ResistorMode resistorMode;

            public DigitalIOImplementation(byte pin, bool initialState, GlitchFilterMode glitchFilter, Port.ResistorMode resistorMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
            ...
            public override IOMode Mode
            {
                ...
                {
                    this.mode = value;
                    this.io60.setIOMode(this.pin, this.mode == IOMode.Input ? IO60P16.IOState.Input : IO60P16.IOState.Output, this.resistorMode);
                }
            }
        }

        private class AnalogInputImplementation : FrameWork.AnalogInput
        {
            private ADS7830 ads;
            private IO60P16 io60;
            private byte pin;
        ...
        private class PwmOutputImplementation : PwmOutput
        {
            private IO60P16 io60;
            private byte pin;
            ...
            public override void Set(uint period, uint highTime, PwmScaleFactor factor)
            {
                ...
                switch (factor)
                {
                    case PwmScaleFactor.Milliseconds: frequency = 1000 / period; break;
                    case PwmScaleFactor.Microseconds: frequency = 1000000 / period; break;
                    case PwmScaleFactor.Nanoseconds: frequency = 1000000000 / period; break;
                }
            ...
            public override bool IsActive
            {
                ...
                set
                {
                    ...
                    if (this.isActive)
                    {
                        this.io60.setIOMode(this.pin, IO60P16.IOState.PWM, Port.ResistorMode.Disabled);
                        this.io60.setPWM(this.pin, 1, 0.5);
                    }
                    else
                    {
                        this.io60.setIOMode(this.pin, IO60P16.IOState.Input, Port.ResistorMode.Disabled);
                    }
                }
            }
        }

        private class InterruptInputImplementation : InterruptInput
        {
            private IO60P16 io60;
            private byte pin;
            ...
            public InterruptInputImplementation(byte pin, GlitchFilterMode glitchFilter, Port.ResistorMode resistorMode, InterruptMode interruptMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
        ...
        private class IO60P16
        {
            ...
            public void setIOMode(byte pin, IOState state, Port.ResistorMode resistorMode)
            {
                switch (resistorMode)
                {
                    case Port.ResistorMode.Disabled: this.setIOMode(pin, state, ResistorMode.Floating); break;
                    case Port.ResistorMode.PullDown: this.setIOMode(pin, state, ResistorMode.PullDown); break;
                    case Port.ResistorMode.PullUp: this.setIOMode(pin, state, ResistorMode.PullUp); break;
                }
            }

            public void setIOMode(byte pin, IOState state, HardWare.HubAP5.IO60P16.ResistorMode resistorMode)
            {
        ...
        private class ADS7830
        {
            ...
            public ADS7830()
            {
                this.i2c = I2CBusFactory.Create(ADS7830.I2C_ADDRESS, 400);
            }
