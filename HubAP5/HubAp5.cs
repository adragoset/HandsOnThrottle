...
namespace HubAP5
{
    public enum IOMode { Input, Output, Interrupt }
    /// <summary>
    ...
    public class HubAP5
    {
        ...
        /// </summary>
        public static byte[] HubSocket1 = new byte[] { 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56 }; //Socket 1

        /// <summary>
        /// Returns the socket number for socket 2 on the hub.
        /// </summary>
        public static byte[] HubSocket2 = new byte[] { 0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46 };

        /// <summary>
        /// Returns the socket number for socket 3 on the hub.
        /// </summary>
        public static byte[] HubSocket3 = new byte[] { 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36 };

        /// <summary>
        /// Returns the socket number for socket 4 on the hub.
        /// </summary>
        public static byte[] HubSocket4 = new byte[] { 0x20, 0x21, 0x22, 0x23, 0x74, 0x75, 0x76 };

        /// <summary>
        /// Returns the socket number for socket 5 on the hub.
        /// </summary>
        public static byte[] HubSocket5 = new byte[] { 0x14, 0x15, 0x16, 0x17, 0x71, 0x72, 0x73 };

        /// <summary>
        /// Returns the socket number for socket 6 on the hub.
        /// </summary>
        public static byte[] HubSocket6 = new byte[] { 0x10, 0x11, 0x12, 0x13, 0x66, 0x67, 0x70 };

        /// <summary>
        /// Returns the socket number for socket 7 on the hub.
        /// </summary>
        public static byte[] HubSocket7 = new byte[] { 0x04, 0x05, 0x06, 0x07, 0x63, 0x64, 0x65 };

        /// <summary>
        /// Returns the socket number for socket 8 on the hub.
        /// </summary>
        public static byte[] HubSocket8 = new byte[] { 0x00, 0x01, 0x02, 0x03, 0x60, 0x61, 0x62 };

        /// <summary>Constructs a new HubAP5 module.</summary>
        /// <param name="socketNumber">The socket that this module is plugged in to.</param>
        public HubAP5(Cpu.Pin interrupt)
        {
            this.io60 = new IO60P16(interrupt);
            this.ads = new ADS7830();
        }

        private class DigitalInputImplementation
        {
            private IO60P16 io60;
            private byte pin;

            public DigitalInputImplementation(byte pin, bool glitchFilter, Port.ResistorMode resistorMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
        ...
        private class DigitalOutputImplementation
        {
            private IO60P16 io60;
            private byte pin;
        ...
        private class DigitalIOImplementation
        {
            private IO60P16 io60;
            private byte pin;
            private IOMode mode;
            ...
            public DigitalIOImplementation(byte pin, bool initialState, bool glitchFilter, Port.ResistorMode resistorMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
        ...
        private class AnalogInputImplementation
        {
            private ADS7830 ads;
            private IO60P16 io60;
            private byte pin;
        ...
        private class PwmOutputImplementation
        {
            private IO60P16 io60;
            private byte pin;
            ...
            public void Set(uint period, uint highTime, PWM.ScaleFactor factor)
            {
                ...
                switch (factor)
                {
                    case PWM.ScaleFactor.Milliseconds: frequency = 1000 / period; break;
                    case PWM.ScaleFactor.Microseconds: frequency = 1000000 / period; break;
                    case PWM.ScaleFactor.Nanoseconds: frequency = 1000000000 / period; break;
                }
        ...
        private class InterruptInputImplementation : InterruptInput
        {
            ...
            public InterruptInputImplementation(byte pin, bool glitchFilter, Port.ResistorMode resistorMode, Port.InterruptMode interruptMode, IO60P16 io60)
            {
                this.io60 = io60;
                this.pin = pin;
        ...
        private class IO60P16
        {
            ...
            {
                public Port.InterruptMode mode;
                    ...
                    lock (this.interruptHandlers)
                    {
                        foreach (InterruptRegistraton reg in this.interruptHandlers)
                        {
                            if (reg.pin == pin)
                            {
                                ...
                                if ((reg.mode == Port.InterruptMode.InterruptEdgeHigh && val) || (reg.mode == Port.InterruptMode.InterruptEdgeLow && !val) || reg.mode == Port.InterruptMode.InterruptEdgeBoth)
                                    reg.handler(val);
                            }
                        }
                    }
            ...
            public IO60P16(Cpu.Pin interrupt)
            {
                this.io60Chip = I2CBusFactory.Create(0x20, 100);

                this.interrupt = new InterruptPort(interrupt, true, Port.ResistorMode.Disabled, Port.InterruptMode.InterruptEdgeHigh);
                this.interrupt.OnInterrupt += this.OnInterrupt;
            }

            public void registerInterruptHandler(byte pin, Port.InterruptMode mode, InterruptHandler handler)
            {
